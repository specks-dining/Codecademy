...
for transaction in daily_transactions_split:
    ...
    for data_point in transaction:
        cleaned_data_point = data_point.strip()
        cleaned_transaction.append(cleaned_data_point)
...
for transaction in transactions_clean:
    ...
    sale_amount = transaction[1]
    threads_sold_amount = transaction[2]
    
    customers.append(customer_name)
    sales.append(sale_amount)
    thread_sold.append(threads_sold_amount)
